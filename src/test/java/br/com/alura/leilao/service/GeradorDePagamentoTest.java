...
class GeradorDePagamentoTest {
	...
	void deveriaCriarPagamentoParaVencedorDoLeilao() {
		...
		LocalDate data = LocalDate.of(2021, 4, 9);
		...
		Assert.assertEquals(LocalDate.now().plusDays(2), pagamento.getVencimento());
	...
	private Leilao leilao(){
		...
		Lance lance = new Lance(new Usuario("Sicrano"), new BigDecimal("900"));
